...
////// TEST FOR getInteviewersForDay //////

test("getInteviewersForDay returns an array", () => {
  const result = getInterviewersForDay(state, "Monday");
  expect(Array.isArray(result)).toBe(true);
});

test("getInteviewersForDay returns an array with a length matching the number of appointments for that day", () => {
  const result = getInterviewersForDay(state, "Monday");
  expect(result.length).toEqual(3);
});

test("getInteviewersForDay returns an array containing the correct interviewers objects", () => {
...
test("getInteviewersForDay returns an empty array when the days data is empty", () => {
  const result = getInterviewersForDay({ days: [] }, "Monday");
  expect(result.length).toEqual(0);
});

test("getInteviewersForDay returns an empty array when the day is not found", () => {
